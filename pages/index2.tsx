...
const NavItem: React.FC<NavItemProps> = ({ href, isActive, children }) => (
  <li>
    <Link href={href}>
      <a
        className={`font-display block px-4 py-2 hover:bg-blue-100 rounded-md ${isActive ? 'bg-blue-200 text-blue-700' : ''}`}
      >
        {children}
      </a>
    </Link>
...
const IndexPage = () => (
  <div className="divide-y divide-gray-100">
    <Nav>
      <h1 className="font-bold px-4 py-2 text-xl">Ketan Agrawal</h1>
      <NavItem href="/" isActive>Home</NavItem>
      <NavItem href="/blog">Blog</NavItem>
      <NavItem href="/garden">Garden</NavItem>
    </Nav>
    <div className="space-y-6 p-6">
      <div className="flex flex-col md:flex-row max-w-4xl justify-around align-items-center pb-8">
        <Box><div className="rounded-full flex items-center justify-center"><Image className="rounded-full" src="/me.jpg" width="300" height="300" /></div></Box>
        <Box>
          <div className="flex-col space-y-4">
            <p className="font-display text-2xl font-bold">Who am I?</p>
      ...
      <p className="font-display text-lg px-4 font-bold">Work Experience</p>
